...
class PatientIdentifiersController {
    ...
    async index(request, reply) {
        try {
            const patientIdentifiers = await db.select({
                id: patient_identifiers.id,
                name: patient_identifiers.name,
                createdAt: patient_identifiers.createdAt,
                updatedAt: patient_identifiers.updatedAt,
