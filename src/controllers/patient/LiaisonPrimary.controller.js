...
export const index = async (request, reply) => {
  try {
    const liaisons = await db.select({
      id: liaison_primary.id,
      first_name: liaison_primary.first_name,
      last_name: liaison_primary.last_name,
      phone: liaison_primary.phone,
      email: liaison_primary.email,
      relationship: liaison_primary.relationship,
      createdAt: liaison_primary.createdAt,
      updatedAt: liaison_primary.updatedAt,
...
export const store = async (request, reply) => {
  try {
    logger.info("🔍 LiaisonPrimary store called - User:", request.user?.id)
    console.log(
    ...
    logger.info("✅ LiaisonPrimary store - Created liaison:", result?.id)
    ...
    logger.error("❌ Error in LiaisonPrimary store:", error)
