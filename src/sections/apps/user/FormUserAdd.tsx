...
const FormUserAdd = ({ customer, closeModal }: { customer: CustomerList | null; closeModal: () => void }) => {
  ...
  return (
    <>
      ...
      {customer && <AlertUserDelete id={customer.id!} title={customer.name} open={openAlert} handleClose={handleAlertClose} />}
    </>
  );
};
