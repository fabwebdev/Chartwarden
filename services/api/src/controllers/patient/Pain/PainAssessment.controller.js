...
export const index = async (request, reply) => {
  try {
    const painAssessments = await db.select({
      id: pain_assessments.id,
      patient_id: pain_assessments.patient_id,
      pain_level_now: pain_assessments.pain_level_now,
      acceptable_level_of_pain: pain_assessments.acceptable_level_of_pain,
      worst_pain_level: pain_assessments.worst_pain_level,
      primary_pain_site: pain_assessments.primary_pain_site,
      createdAt: pain_assessments.createdAt,
      updatedAt: pain_assessments.updatedAt
...
export const painLevelSeveritystore = async (request, reply) => {
  try {
    ...
    logger.error("Error in painLevelSeveritystore:", error)
    reply.code(500);
    return { message: "Server error" };
  }
};
...
export const painRatedByStore = async (request, reply) => {
  try {
    ...
    logger.error("Error in painRatedByStore:", error)
...
export const painRatedById = async (request, reply) => {
  try {
    ...
    logger.error("Error in painRatedById:", error)
    reply.code(500);
    return { message: "Server error" };
  }
};
...
export const painDurationStore = async (request, reply) => {
  try {
    ...
    logger.error("Error in painDurationStore:", error)
    console.error("Error details:", {
      message: error.message,
      stack: error.stack,
      body: request.body,
...
export const painDurationById = async (request, reply) => {
  try {
    ...
    logger.error("Error in painDurationById:", error)
    reply.code(500);
    return { message: "Server error" };
  }
};
...
export const painFrequencyStore = async (request, reply) => {
  try {
    ...
    logger.error("Error in painFrequencyStore:", error)
    console.error("Error details:", {
      message: error.message,
      stack: error.stack,
      body: request.body,
...
export const painFrequencyById = async (request, reply) => {
  try {
    ...
    logger.error("Error in painFrequencyById:", error)
    reply.code(500);
    return { message: "Server error" };
  }
};
...
export const painObservationStore = async (request, reply) => {
  try {
    ...
    // Convert array to JSON string if it's an array, otherwise keep as is
    const painObservationsIdString = Array.isArray(pain_observations_id)
      ? JSON.stringify(pain_observations_id)
    ...
    if (painObservation) {
      ...
      const updatedObservation = await db
        ...
        .set({ 
          pain_observations_id: painObservationsIdString,
          updatedAt: now,
        })
        .where(eq(pain_observations.patient_id, parseInt(patient_id)))
        .returning();
    ...
    logger.error("Error in painObservationStore:", error)
    reply.code(500);
    return { message: "Server error" };
  }
};
...
export const painObservationById = async (request, reply) => {
  try {
    ...
    // Parse JSON string back to array if it exists
    if (painObservation.pain_observations_id) {
      try {
        painObservation.pain_observations_id = JSON.parse(painObservation.pain_observations_id);
      } catch (e) {
        // If parsing fails, keep as string (might be old format)
      }
    }
    ...
    logger.error("Error in painObservationById:", error)
    reply.code(500);
    return { message: "Server error" };
  }
};
...
export const painWorsenedByStore = async (request, reply) => {
  try {
    ...
    logger.error("Error in painWorsenedByStore:", error)
    console.error("Error details:", {
      message: error.message,
      stack: error.stack,
      body: request.body,
...
export const painWorsenedById = async (request, reply) => {
  try {
    ...
    logger.error("Error in painWorsenedById:", error)
    reply.code(500);
    return { message: "Server error" };
  }
};
...
export const painCharacterStore = async (request, reply) => {
  try {
    ...
    logger.error("Error in painCharacterStore:", error)
    console.error("Error details:", {
      message: error.message,
      stack: error.stack,
      body: request.body,
...
export const painCharacterById = async (request, reply) => {
  try {
    ...
    logger.error("Error in painCharacterById:", error)
    reply.code(500);
    return { message: "Server error" };
  }
};
...
export const painRelievedByStore = async (request, reply) => {
  try {
    ...
    logger.error("Error in painRelievedByStore:", error)
    console.error("Error details:", {
      message: error.message,
      stack: error.stack,
      body: request.body,
...
export const painRelievedById = async (request, reply) => {
  try {
    ...
    logger.error("Error in painRelievedById:", error)
    reply.code(500);
    return { message: "Server error" };
  }
};
...
export const painEffectsOnFunctionStore = async (request, reply) => {
  try {
    ...
    logger.error("Error in painEffectsOnFunctionStore:", error)
    console.error("Error details:", {
      message: error.message,
      stack: error.stack,
      body: request.body,
...
export const painEffectsOnFunctionById = async (request, reply) => {
  try {
    ...
    logger.error("Error in painEffectsOnFunctionById:", error)
    reply.code(500);
    return { message: "Server error" };
  }
};
...
export const painBreakthroughStore = async (request, reply) => {
  try {
    ...
    logger.error("Error in painBreakthroughStore:", error)
    console.error("Error details:", {
      message: error.message,
      stack: error.stack,
      body: request.body,
...
export const painBreakthroughById = async (request, reply) => {
  try {
    ...
    logger.error("Error in painBreakthroughById:", error)
    reply.code(500);
    return { message: "Server error" };
  }
};
...
export const typeOfPainRatingScaleUsedStore = async (request, reply) => {
  try {
    ...
    logger.error("Error in typeOfPainRatingScaleUsedStore:", error)
    console.error("Error details:", {
      message: error.message,
      stack: error.stack,
      body: request.body,
...
export const typeOfPainRatingScaleUsedById = async (request, reply) => {
  try {
    ...
    logger.error("Error in typeOfPainRatingScaleUsedById:", error)
    reply.code(500);
    return { message: "Server error" };
  }
};
...
export const painVitalSignsStore = async (request, reply) => {
  try {
    ...
    logger.error("Error in painVitalSignsStore:", error)
    console.error("Error details:", {
      message: error.message,
      stack: error.stack,
      body: request.body,
...
export const painVitalSignsById = async (request, reply) => {
  try {
    ...
    logger.error("Error in painVitalSignsById:", error)
    reply.code(500);
    return { message: "Server error" };
  }
};
...
export const painScalesToolsLabDataReviewsStore = async (request, reply) => {
  try {
    ...
    logger.error("Error in painScalesToolsLabDataReviewsStore:", error)
    console.error("Error details:", {
      message: error.message,
      stack: error.stack,
      body: request.body,
...
export const painScalesToolsLabDataReviewsById = async (request, reply) => {
  try {
    ...
    logger.error("Error in painScalesToolsLabDataReviewsById:", error)
    reply.code(500);
    return { message: "Server error" };
  }
};
...
export const painAssessmentInDementiaScaleStore = async (request, reply) => {
  try {
    ...
    logger.error("Error in painAssessmentInDementiaScaleStore:", error)
    console.error("Error details:", {
      message: error.message,
      stack: error.stack,
      body: request.body,
...
export const painAssessmentInDementiaScaleById = async (request, reply) => {
  try {
    ...
    logger.error("Error in painAssessmentInDementiaScaleById:", error)
    reply.code(500);
    return { message: "Server error" };
  }
};
...
export const flaccBehavioralPainStore = async (request, reply) => {
  try {
    ...
    logger.error("Error in flaccBehavioralPainStore:", error)
    console.error("Error details:", {
      message: error.message,
      stack: error.stack,
      body: request.body,
...
export const flaccBehavioralPainById = async (request, reply) => {
  try {
    ...
    logger.error("Error in flaccBehavioralPainById:", error)
    reply.code(500);
    return { message: "Server error" };
  }
};
...
export const painScreeningStore = async (request, reply) => {
  try {
    ...
    logger.error("Error in painScreeningStore:", error)
    console.error("Error details:", {
      message: error.message,
      stack: error.stack,
      body: request.body,
...
export const painScreeningById = async (request, reply) => {
  try {
    ...
    logger.error("Error in painScreeningById:", error)
    reply.code(500);
    return { message: "Server error" };
  }
};
...
export const painSummaryInterventionsGoalsStore = async (request, reply) => {
  try {
    ...
    logger.error("Error in painSummaryInterventionsGoalsStore:", error)
    console.error("Error details:", {
      message: error.message,
      stack: error.stack,
      body: request.body,
...
export const painSummaryInterventionsGoalsById = async (request, reply) => {
  try {
    ...
    logger.error("Error in painSummaryInterventionsGoalsById:", error)
    reply.code(500);
    return { message: "Server error" };
  }
};
...
export const comprehensivePainAssessmentStore = async (request, reply) => {
  try {
    ...
    logger.error("Error in comprehensivePainAssessmentStore:", error)
    console.error("Error details:", {
      message: error.message,
      stack: error.stack,
      body: request.body,
...
export const comprehensivePainAssessmentById = async (request, reply) => {
  try {
    ...
    logger.error("Error in comprehensivePainAssessmentById:", error)
    reply.code(500);
    return { message: "Server error" };
  }
};
...
export const painActiveProblemStore = async (request, reply) => {
  try {
    ...
    logger.error("Error in painActiveProblemStore:", error)
    console.error("Error details:", {
      message: error.message,
      stack: error.stack,
      body: request.body,
...
export const painActiveProblemById = async (request, reply) => {
  try {
    ...
    logger.error("Error in painActiveProblemById:", error)
    reply.code(500);
    return { message: "Server error" };
  }
};
