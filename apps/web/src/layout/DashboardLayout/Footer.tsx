...
const Footer = () => (
  <Stack direction="row" justifyContent="space-between" alignItems="center" sx={{ p: '24px 16px 0px', mt: 'auto' }}>
    <Typography variant="caption"> Copyright © 2024 Engrace Hospice</Typography>
    <Stack spacing={1.5} direction="row" justifyContent="space-between" alignItems="center">
      <Links component={Link} href="https://ableproadmin.com" target="_blank" variant="caption" color="textPrimary">
        Home
      </Links>
      <Links component={Link} href="https://phoenixcoded.gitbook.io/able-pro/v/react" target="_blank" variant="caption" color="textPrimary">
        Documentation
      </Links>
