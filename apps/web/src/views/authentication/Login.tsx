  ...
  return (
    <AuthWrapper>
      <Grid container spacing={3}>
        ...
        <Grid item xs={12}>
          <Stack spacing={1.5}>
            <AuthSocButton onClick={handleGoogleLogin} disabled={isGoogleLoading || isGitHubLoading}>
              {isGoogleLoading ? (
            ...
            <AuthSocButton onClick={handleGitHubLogin} disabled={isGoogleLoading || isGitHubLoading}>
              {isGitHubLoading ? (
                <CircularProgress size={16} />
              ) : (
                <Box
